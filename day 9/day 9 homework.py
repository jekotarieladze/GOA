...
family = ["elene","koba","jeko"]
entire_sentance = "my mom is 45 and her name is: {}, my father is 48 years old and his name is: {},i am 14 and my name is: {}".format(family[0],family[1],family[2])
print(entire_sentance)